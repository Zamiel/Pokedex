export const MOCK_POKEMON_ABILITY = {
  effect_changes: [
    {
      effect_entries: [
        {
  ...
  flavor_text_entries: [
    ...
    {
      flavor_text: 'The stench helps keep\nwild Pokémon away.',
      language: {
        name: 'en',
        url: 'https://pokeapi.co/api/v2/language/9/',
      },
    ...
    {
      flavor_text: 'The stench may cause\nthe target to flinch.',
      language: {
        name: 'en',
        url: 'https://pokeapi.co/api/v2/language/9/',
      },
    ...
    {
      flavor_text: 'La puanteur peut effrayer\nl’adversaire.',
      language: {
        name: 'fr',
        url: 'https://pokeapi.co/api/v2/language/5/',
      },
    ...
    {
      flavor_text: 'Lässt den Gegner durch Gestank\nzurückschrecken.',
      language: {
        name: 'de',
        url: 'https://pokeapi.co/api/v2/language/6/',
      },
    ...
    {
      flavor_text: 'Es posible que el rival retroceda\npor el mal olor.',
      language: {
        name: 'es',
    ...
    {
      flavor_text: 'A volte il cattivo odore\nfa tentennare i nemici.',
      language: {
        name: 'it',
    ...
    {
      flavor_text: 'くさい　においを　はなつことによって\nこうげきした　ときに　あいてを\nひるませることが　ある。',
      language: {
        name: 'ja-Hrkt',
        url: 'https://pokeapi.co/api/v2/language/1/',
      },
    ...
    {
      flavor_text: 'Le Pokémon émet une odeur si nauséabonde\nqu’il peut effrayer sa cible.',
      language: {
        name: 'fr',
        url: 'https://pokeapi.co/api/v2/language/5/',
      },
    ...
    {
      flavor_text: 'Lässt das Ziel beim Angriff eventuell durch Gestank\nzurückschrecken.',
      language: {
        name: 'de',
        url: 'https://pokeapi.co/api/v2/language/6/',
      },
    ...
    {
      flavor_text: 'Debido al mal olor que emana, al atacar al rival puede\nhacerlo retroceder.',
      language: {
        name: 'es',
        url: 'https://pokeapi.co/api/v2/language/7/',
      },
    ...
    {
      flavor_text: 'A volte il cattivo odore emesso dal Pokémon\nfa tentennare i nemici quando attacca.',
      language: {
        name: 'it',
        url: 'https://pokeapi.co/api/v2/language/8/',
      },
    ...
    {
      flavor_text: 'By releasing stench when attacking, this Pokémon\nmay cause the target to flinch.',
      language: {
        name: 'en',
        url: 'https://pokeapi.co/api/v2/language/9/',
      },
